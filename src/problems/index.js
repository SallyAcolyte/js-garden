...
const stringProblems = [
  ...
  {
    id: 'extract-query-value',
    title: 'クエリ文字列から値を取得',
    summary: 'URL パスから指定パラメータの値を取り出します。',
    difficulty: 'Easy',
    tags: ['string', 'web'],
    functionName: 'extractQueryValue',
    prompt: prompt([
      'URL 風の文字列 `path` から、クエリパラメータ `target` に対応する値を返してください。',
    ...
    tests: [
      ...
      { description: '値が空文字', args: ['/reset?token=', 'token'], expected: '' },
    ],
  },
  {
    id: 'format-breadcrumb',
    title: 'パンくずリストの整形',
    summary: 'URL パスをヒューマンリーダブルなパンくず表記に変換します。',
    difficulty: 'Easy',
    tags: ['string', 'web'],
    functionName: 'formatBreadcrumb',
    prompt: prompt([
      'スラッシュで区切られたパス `path` を、各セグメントをタイトルケースにして ` > ` で連結した文字列に変換してください。',
    ...
    tests: [
      ...
      { description: '空の結果', args: [''], expected: '' },
    ],
  },
  {
    id: 'mask-email-address',
    title: 'メールアドレスのマスキング',
    summary: 'ユーザー名とドメインの一部を伏せ字にします。',
    difficulty: 'Easy',
    tags: ['string', 'security'],
    functionName: 'maskEmailAddress',
    prompt: prompt([
      'メールアドレス形式の文字列 `input` を、ユーザー名の最初の文字とドメイン部分だけを残し、残りを `*` に置き換えた文字列にしてください。',
